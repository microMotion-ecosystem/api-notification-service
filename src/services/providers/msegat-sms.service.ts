...
import {
  IMsegatAddSenderArgs,
  IMsegatCalculateCostArgs,
  IMsegatGetCreditsArgs,
  IMsegatGetMessagesArgs,
  IMsegatGetSendersArgs,
  IMsegatSendSmsArgs,
  IMsegatSendSmsWithVarsArgs,
  IMsegatVerifyOTPCodeArgs,
} from './interfaces/msegat.interfaces';
...
export class MsegatSmsService {
  ...
  constructor(
    ...
    private readonly providersConfigs: ProviderConfigurationService,
    ...
    const providerData = this.providersConfigs.get('msg_sms');
    if (providerData) {
  ...
  async getCredits(data: IMsegatGetCreditsArgs): Promise<any> {
    ...
    const response = await lastValueFrom(
      this.httpService.post(`${this.baseURL}/Credits.php`, formData, {
        headers,
      }),
    );
  ...
  async sendSms(data: IMsegatSendSmsArgs): Promise<any> {
    const headers = {
    ...
    const response = await lastValueFrom(
      this.httpService.post(`${this.baseURL}/sendsms.php`, cleanedData, {
        headers,
      }),
    );
    console.log(response.data);
  ...
  async getMessages(data: IMsegatGetMessagesArgs): Promise<void> {
    const headers = {
      'Content-Type': 'application/json',
    };
    if (!data.apiKey) {
    ...
    const response = await lastValueFrom(
      this.httpService.post(`${this.baseURL}/getMessages.php`, data, {
        headers,
      }),
    );
    console.log(response.data);
  ...
  async sendSmsWithVars(data: IMsegatSendSmsWithVarsArgs): Promise<void> {
    const headers = {
      'Content-Type': 'application/json',
    };
    if (!data.apiKey) {
  ...
  async calculateCost(data: IMsegatCalculateCostArgs): Promise<void> {
    const formData = new FormData();
    formData.append('userName', data.userName || this.userName);
    formData.append('apiKey', data.apiKey || this.apiKey);
    ...
    const response = await lastValueFrom(
      this.httpService.post(`${this.baseURL}/calculateCost.php`, formData, {
        headers,
      }),
    );
    console.log(response.data);
  ...
  async addSender(data: IMsegatAddSenderArgs): Promise<void> {
    const formData = new FormData();
    formData.append('userName', data.userName || this.userName);
    formData.append('apiKey', data.apiKey || this.apiKey);
    ...
    const response = await lastValueFrom(
      this.httpService.post(`${this.baseURL}/addSender.php`, formData, {
        headers,
      }),
    );
    console.log(response.data);
  ...
  async getSenders(data: IMsegatGetSendersArgs): Promise<void> {
    const headers = {
      'Content-Type': 'application/json',
    };
    if (!data.apiKey) {
  ...
  async sendOTPCode(data: MsegatSendOTPCodeArgs): Promise<any> {
    ...
    const response = await lastValueFrom(
      this.httpService.post(`${this.baseURL}/sendOTPCode.php`, data, {
        headers,
      }),
    );
    console.log(response.data);
  ...
  async verifyOTPCode(data: IMsegatVerifyOTPCodeArgs): Promise<any> {
    const headers = {
      'Content-Type': 'multipart/form-data',
    };
    if (!data.apiKey) {
    ...
    const response = await lastValueFrom(
      this.httpService.post(`${this.baseURL}/verifyOTPCode.php`, data, {
        headers,
      }),
    );
    console.log(response.data);
