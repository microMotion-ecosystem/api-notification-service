export interface MsegatSendSmsArgs {
...
export interface MsegatGetMessagesArgs {
    apiKey?: string;
    userName?: string;
    numbers: string;
    reqBulkId: string;
...
export interface MsegatSendSmsWithVarsArgs {
    apiKey?: string;
    userName: string;
    userSender: string;
    msg: string;
...
export interface MsegatCalculateCostArgs {
    apiKey?: string;
    userName: string;
    contactType: string;
    contacts: string;
...
export interface MsegatVerifyOTPCodeArgs {
    apiKey?: string;            // apiKey (required, string, apiKey associated with the account)
...
export interface MsegatAddSenderArgs {
    apiKey?: string;         // apiKey (required, string, apiKey associated with the account)
    userName: string;       // userName (required, string, username for the account in Msegat.com)
...
export interface MsegatGetSendersArgs {
    apiKey?: string;
    userName: string;
}

export interface MsegatGetCreditsArgs {
    apiKey?: string;
    userName?: string;
}
