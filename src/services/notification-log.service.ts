...
export class NotificationLogService {
    constructor(@InjectModel('NotificationLog') private readonly notificationModel: Model<INotificationLogDocument>) {}

    async create(notification: INotificationLogDocument): Promise<INotificationLogDocument> {
    ...
    async update(id: string, notification: INotificationLogDocument): Promise<INotificationLogDocument> {
        return this.notificationModel.findByIdAndUpdate(id, notification, {new: true});
    }
    //
